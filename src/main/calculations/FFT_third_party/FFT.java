 ...
 */
package main.calculations.FFT_third_party;
...
public class FFT
{
	 ...
	 */
	public double[] generateSignal(double[] doubles)
	{
		
		double[] signal = doubles;
...
//				6.89738, 6.631, 6.20138, 5.62319, 4.91623, 4.10463, 3.216};
	 ...
	 * @param args
	 */
	public void get_FFT(double[] doubles)
	{
		// boot strap 
		FFT calc = new FFT();
		double[] signal = calc.generateSignal(doubles);
